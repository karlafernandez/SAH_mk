        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class=" span10">
                    ...
                    <div align="rigth" style="text-position:rigth; margin-left: 80%;">
                        <script type="text/javascript" src="http://www.skypeassets.com/i/scom/js/skype-uri.js"></script>
                            <div id="SkypeButton_Call_karla.mariel.fer_1">
                              <script type="text/javascript">
                                Skype.ui({
                                  "name": "dropdown",
                                  "element": "SkypeButton_Call_karla.mariel.fer_1",
                                  "participants": ["karla.mariel.fer"],
                                  "imageSize": 32
                                });
                              </script>
                            </div>
