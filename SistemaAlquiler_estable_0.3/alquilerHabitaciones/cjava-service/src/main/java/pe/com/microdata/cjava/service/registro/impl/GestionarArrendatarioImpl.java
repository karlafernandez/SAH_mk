 ...
 * @author meliMeli
 */
@Service("gestionarArrendatario")
public class GestionarArrendatarioImpl implements GestionarArrendatario {
    ...
    private static final Logger logger = Logger.getLogger(GestionarArrendatarioImpl.class.getName());
     ...
     private void obtenerCodigoInstructor(Integer idInstructor) {
        ...
        ArrendatarioVO instructorVO = arrendatarioDAO.obtenerArrendatarioPorIdArrendatario(idInstructor);
   ...
   @Override
    public void eliminarArrendatario(Integer arrendatario) {
        ...
        ArrendatarioVO instructorVO = arrendatarioDAO.obtenerArrendatarioPorIdArrendatario(arrendatario);
                
        arrendatarioDAO.delete(instructorVO);
...
//        personaDAO.delete(personaVO);
    ...
    public List obtenerArrendatarioPorBusqueda(BusquedaDTO busquedaDTO) {
        ...
        List<ArrendatarioVO> instructorVOs = arrendatarioDAO.obtenerArrendatarioPorBusqueda(busquedaDTO);
    ...
    public Long obtenerTotalArrendatariosPorBusqueda(BusquedaDTO busquedaDTO) {
        Long total = arrendatarioDAO.obtenerTotalArrendatariosPorBusqueda(busquedaDTO);
    ...
    public SIGAMessage registrarArrendatario(ArrendatarioDTO instructorDTO) {
        ...
        try {
            ...
            Integer idInstructor = arrendatarioDAO.insert(instructorVO);
            if (idInstructor != 0) {
...
//        PersonaVO personaVO = new PersonaVO();
        ...
        ArrendatarioVO instructorVO = arrendatarioDAO.obtenerArrendatarioPorIdArrendatario(instructorDTO.getIdInstructor());
        ...
        try {
            ...
            Logger.getLogger(GestionarArrendatarioImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
        personaVO.setTipoUserVO(new SubTipoVO(Constants.SUBTIPO_USER_INSTRUCTOR));
        personaDAO.saveOrUpdate(personaVO);
        ...
        instructorVO.setInstructorPersonaVO(personaVO);
        arrendatarioDAO.saveOrUpdate(instructorVO);
        msg.setSuccess(Boolean.TRUE);
        return msg;
