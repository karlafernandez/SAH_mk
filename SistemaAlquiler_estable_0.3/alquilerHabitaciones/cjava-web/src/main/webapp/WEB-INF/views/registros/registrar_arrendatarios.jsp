...
<sec:authorize access="hasRole('MOD_ADM_CREAR_INSTRUCTOR')">
    <script src="<c:url value='/js/registro/instructor/registrar_ins.js'/>" type="text/javascript"></script>
    <script src="<c:url value='/js/validaciones.js'/>" type="text/javascript"></script>

    <div class="container-fluid fondoGris"> 
        <div class="row-fluid  div-titulo">
            <h3 class="span6">Registrar Instructor </h3>
        ...
        <div class="row-fluid formulario">
            <c:url var="url" value="/registrarInstructores.html" />
            <form:form id="frmDatosInstructor" modelAttribute="datosBasicos"   method="post"  action="${url}" cssClass="form-horizontal"> 


                <fieldset>
                    <legend>Datos Instructor</legend>    
                    <div class="row-fluid">
                        <div class="span6">
