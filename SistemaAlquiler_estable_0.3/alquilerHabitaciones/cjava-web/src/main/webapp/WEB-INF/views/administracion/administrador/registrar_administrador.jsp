...
<sec:authorize access="hasRole('MOD_ADM_REGISTRAR_ADMINISTRADOR')">
    <script src="<c:url value='/js/administracion/administrador/administrador.registrar.js'/>" type="text/javascript"></script>
    <script src="<c:url value='/js/validaciones.js'/>" type="text/javascript"></script>

    <div class="container-fluid fondoGris"> 
        <div class="row-fluid  div-titulo">
            <h3 class="span6">Registrar Administrador </h3>
        ...
        <div class="row-fluid formulario">
            <c:url var="url" value="/registrar-administrador.html" />
            <form:form id="frmDatosAdministrador" modelAttribute="modAdmin" method="post"  action="${url}" cssClass="form-horizontal"> 
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group">
                                ...
                                <div class="controls"> 
                                    <form:input id="nomUser" path="nomUser" type="text" cssClass="input-medium"/>
                                    <form:errors path="nomUser" cssClass="help-block"/>  
                                </div>
                            </div>
                        </div>  
                    </div> 
